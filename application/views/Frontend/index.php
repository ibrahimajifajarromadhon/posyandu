			...
			<div class="col-lg-12">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p></p>
						<a class="btn-solid-lg page-scroll" href="<?php echo base_url() . 'Frontend/about' ?>">OPEN</a>
					</div>
				</div>
				<!-- end of card -->
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<p></p>
						<a class="btn-solid-lg page-scroll" href="<?php echo base_url() . 'Frontend/pertumbuhan' ?>">OPEN</a>
					</div>
				</div>
				<!-- end of card -->
				...
				<div class="card">
					<div class="card-image">
						<img class="img-fluid" src="<?php echo base_url() . 'assets/Frontend/images/report.png' ?>" width="100px" alt="alternative">
					</div>
					<div class="card-body">
						<h4 class="card-title">Menu Imunisasi</h4>
						<p></p>
						<a class="btn-solid-lg page-scroll" href="<?php echo base_url() . 'Frontend/imunisasi' ?>">OPEN</a>
					</div>
				</div>
				<!-- end of card -->
			</div> <!-- end of col -->
