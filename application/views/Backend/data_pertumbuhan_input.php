    ...
    <div class="form-row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="date" id="tgl_cek" name="tgl_cek" value="<?php echo set_value('tgl_cek') ?>" class="form-control" placeholder="Masukkan Tanggal Cek">
    ...
    <div class="form-row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="number" id="usia" name="usia" step='any' value="<?php echo set_value('usia') ?>" class="form-control" placeholder="0 bulan">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="number" id="berat_badan" name="berat_badan" step='any' value="<?php echo set_value('berat_badan') ?>" class="form-control" placeholder="0,0 Kg">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="number" id="tinggi_badan" name="tinggi_badan" step='any' value="<?php echo set_value('tinggi_badan') ?>" class="form-control" placeholder="0,0 Cm">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="number" id="lingkar_kepala" name="lingkar_kepala" step='any' value="<?php echo set_value('lingkar_kepala') ?>" class="form-control" placeholder="0,0 Cm">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="number" id="lingkar_lengan" name="lingkar_lengan" step='any' value="<?php echo set_value('lingkar_lengan') ?>" class="form-control" placeholder="0,0 Cm">
