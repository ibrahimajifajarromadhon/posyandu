<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
	<div
		...
		<ul class="flex items-center flex-shrink-0 space-x-6">
			<!-- Profile menu -->
			<li class="relative font-bold">Welcome <?php echo $this->session->userdata('ses_name') ?>
				<button
					class="mx-2 align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
